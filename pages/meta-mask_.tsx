...
function Form() {
    ...
    return (
        ...
        <div className="container-md">
             ...
             width="20%"
             height="20%"
                    src="/logo/lg/c57ca95b47569778a828d19178114f4db188b89b763c899ba0be274e97267d96.jpeg"
                    alt="logo"
                  />
              <h3 id="modal-headline" className="text-lg leading-6 mt-2 font-medium text-justify text-gray-900">
