  ...
  <div className="text-cool-gray-500">
    ...
    <div className="mx-8 mt-8">
      <h2 className="flex justify-center text-3xl font-thin text-center">
        Open protocol for connecting WalletConnect to Dapps
      </h2>
...
const FAQ = () => (
  <TitledContent title="Frequently asked questions" maxwidth="sm:max-w-3xl">
    <FAQContent title="How do I install Wallets?">
    ...
    <FAQContent title="How can I help Wallets project?">
    ...
    <FAQContent title="How can I build a wallet supporting Wallets?">
    ...
    <FAQContent title="How can I add Wallets support to Dapp I developed?">
    ...
    <FAQContent title="How web frontend and mobile wallets communicate?">
      ...
      Wallets Labs runs a public bridge server, but you can also deploy
      your own.
    </FAQContent>
  </TitledContent>
);
  ...
  <div className="flex sm:flex-row sm:justify-center">
    <div className="flex flex-col mx-6 mt-16 font-thin text-gray-700 sm:flex-row sm:mx-8 sm:space-x-16 sm:max-w-5xl">
      <div className="sm:w-1/2">
        <h2 className="text-3xl">What is Is Wallets?</h2>
